...
const InvoiceList = () => {
  const { invoices, deleteInvoice, loading, error } = useContext(InvoiceContext);
                ...
                <TableCell align="center">
                  <Tooltip title="Edit Invoice">
                    <IconButton
                      color="success"
                      component={Link}
                      to={`/apps/invoice/edit/${invoice._id || invoice.id}`}
                    >
                      <IconEdit width={22} />
                    </IconButton>
                  </Tooltip>
                  <Tooltip title="View Invoice">
                    <IconButton
                      color="primary"
                      component={Link}
                      to={`/apps/invoice/detail/${invoice._id || invoice.id}`}
                    >
                      <IconEye width={22} />
                    </IconButton>
                  </Tooltip>
                  <Tooltip title="Delete Invoice">
                    <IconButton
                      color="error"
                      onClick={() => {
                        setSelectedProducts([invoice._id || invoice.id]);
                        handleDelete();
                      }}
                    >
                      <IconTrash width={22} />
