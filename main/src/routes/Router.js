...
const PaymentList = Loadable(lazy(() => import('../components/apps/payments/Payment-list')));
const PaymentCreate = Loadable(lazy(() => import('../components/apps/payments/Add-payment')));
const PaymentDetail = Loadable(lazy(() => import('../views/apps/payments/Detail')));
const PaymentEdit = Loadable(lazy(() => import('../views/apps/payments/Edit')));
const CreditNoteList = Loadable(lazy(() => import('../components/apps/creditnotes/CreditNote-list')));
const CreditNoteCreate = Loadable(lazy(() => import('../components/apps/creditnotes/Add-creditnote')));
const CreditNoteDetail = Loadable(lazy(() => import('../views/apps/creditnotes/Detail')));
const CreditNoteEdit = Loadable(lazy(() => import('../views/apps/creditnotes/Edit')));
const EstimateList = Loadable(lazy(() => import('../components/apps/estimates/Estimate-list')));
const EstimateCreate = Loadable(lazy(() => import('../components/apps/estimates/Add-estimate')));
const EstimateDetail = Loadable(lazy(() => import('../views/apps/estimates/Detail')));
const EstimateEdit = Loadable(lazy(() => import('../views/apps/estimates/Edit')));
...
import AddItems from '../components/apps/items/Add-items/index'; // Import Add-items component
import ListItems from '../components/apps/items/Items-list'; // Import Items-list component
...
const Router = [
  {
    ...
    children: [
      ...
      { path: '/apps/payments/list', element: <PaymentList /> },
      { path: '/apps/payments/create', element: <PaymentCreate /> },
      { path: '/apps/payments/detail/:id', element: <PaymentDetail /> },
      { path: '/apps/payments/edit/:id', element: <PaymentEdit /> },
      { path: '/apps/payments', element: <Navigate to="/apps/payments/list" /> },
      { path: '/apps/creditnotes/list', element: <CreditNoteList /> },
      { path: '/apps/creditnotes/create', element: <CreditNoteCreate /> },
      { path: '/apps/creditnotes/detail/:id', element: <CreditNoteDetail /> },
      { path: '/apps/creditnotes/edit/:id', element: <CreditNoteEdit /> },
      { path: '/apps/creditnotes', element: <Navigate to="/apps/creditnotes/list" /> },
      { path: '/apps/estimates/list', element: <EstimateList /> },
      { path: '/apps/estimates/create', element: <EstimateCreate /> },
      { path: '/apps/estimates/detail/:id', element: <EstimateDetail /> },
      { path: '/apps/estimates/edit/:id', element: <EstimateEdit /> },
      { path: '/apps/estimates', element: <Navigate to="/apps/estimates/list" /> },
      ...
      // Items Module Routes
      { path: '/apps/items/add', element: <AddItems /> },
      { path: '/apps/items/list', element: <ListItems /> },

      // Redirect for items
      { path: '/apps/items', element: <Navigate to="/apps/items/list" /> },
